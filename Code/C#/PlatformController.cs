...
namespace Bundos.MovingPlatforms
{
    ...
    public class PlatformController : MonoBehaviour
    {
        ...
        public float moveSpeed = 5000000f; // Speed of movement
        public float stopDistance = 1f; // Distance to consider reaching a waypoint
        ...
        private bool IsSelected()
        {
            ...
            #else
            return false; // Retourne false lors de l'exécution du jeu
            #endif
        }
